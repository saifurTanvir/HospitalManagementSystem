...
@section('content')
    ...
    <a href="#" class="list-group-item list-group-item-action disabled"><h1>Reciptionist  Department:  <span class="badge badge-info">{{$employeeList[3]}}</span></h1></a>
    </div>
    <hr>
    ...
    <a href="#" class="list-group-item list-group-item-action disabled"><h1>Cardiology Department:  <span class="badge badge-info">{{$doctorList[3]}}</span></h1></span></h1></a>
    <a href="#" class="list-group-item list-group-item-action disabled"><h1>Dental Department:  <span class="badge badge-info">{{$doctorList[4]}}</span></h1></span></h1></span></h1></a>
    </div>
    <hr>
    ...
    <a href="#" class="list-group-item list-group-item-action disabled"><h1>Indoor:  <span class="badge badge-info">{{$patientList[3]}}</span></h1>}</span></h1></span></h1></a>
    <a href="#" class="list-group-item list-group-item-action disabled"><h1>Outdoor:  <span class="badge badge-info">{{$patientList[4]}}</span></h1></span></h1></span></h1></span></h1></a>
    </div>
